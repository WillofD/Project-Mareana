...
const FormatComparison = () => {
  ...
  const testMatchData = playerStatsData.filter((match) => match.match === 'Test');
  ...
  return (
    <div className="w-full h-[45vh]">
      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl font-bold mb-2 sm:mt-8 md:mb-4 lg:mb-4 xl:mb-4">Kohli's Performance Comparison in Different Formats</h2>
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          <Pie data={chartData} dataKey="value" nameKey="name" outerRadius={200} label>
